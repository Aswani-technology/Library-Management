              ...
              <form id="form" action="${pageContext.servletContext.contextPath}/LibraryController" method="post" class="form-horizontal">
                <section class="panel">
                  <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Add New Library</h2>
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="pincode" class="form-control" placeholder="Enter Pincode.." required="" maxlength="6">
                      </div>
                    </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="phoneno" class="form-control" placeholder="Enter Phone Number.." required="" maxlength="10">
                      </div>
                    </div>
                  </div>
                   <input type="hidden" name="command" value="add_library">
