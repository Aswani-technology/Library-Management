	...
	<div class="panel-body">
		...
		<div class="table-responsive">
			<table
				...
				<thead>
					<tr role="row">
						<th class="sorting_asc" tabindex="0"
							...
							style="width: 200px;">First Name</th>
							<th class="sorting_asc" tabindex="0"
							aria-controls="datatable-default" rowspan="1" colspan="1"
							aria-sort="ascending"
							aria-label="Rendering engine: activate to sort column ascending"
							style="width: 200px;">Last Name</th>
							<th class="sorting_asc" tabindex="0"
							aria-controls="datatable-default" rowspan="1" colspan="1"
							aria-sort="ascending"
							aria-label="Rendering engine: activate to sort column ascending"
							style="width: 200px;">Contact</th>
							<th class="sorting_asc" tabindex="0"
							aria-controls="datatable-default" rowspan="1" colspan="1"
							aria-sort="ascending"
							aria-label="Rendering engine: activate to sort column ascending"
				...
				<tbody>
					<c:forEach var="list" items="${librarian_list}">
						<tr>
							...
							<td><a
								href="LibrarianController?command=findLibrarian&id=${list.id}"><button
										type="button" class="btn btn-primary" role="button">Edit</button></a></td>
							<td><a
								href="LibrarianController?command=deleteLibrarian&id=${list.id}">
