	...
	<div class="panel-body">
		...
		<div class="table-responsive">
			<table
				...
				<thead>
					<tr role="row">
						<th class="sorting_asc" tabindex="0"
							...
							style="width: 200px;">Book Name</th>
							<th class="sorting_asc" tabindex="0"
							aria-controls="datatable-default" rowspan="1" colspan="1"
							aria-sort="ascending"
							aria-label="Rendering engine: activate to sort column ascending"
							style="width: 200px;">Publisher</th>
							<th class="sorting_asc" tabindex="0"
							aria-controls="datatable-default" rowspan="1" colspan="1"
							aria-sort="ascending"
							aria-label="Rendering engine: activate to sort column ascending"
							style="width: 200px;">Author</th>
							<th class="sorting_asc" tabindex="0"
							aria-controls="datatable-default" rowspan="1" colspan="1"
							aria-sort="ascending"
							aria-label="Rendering engine: activate to sort column ascending"
				...
				<tbody>
					<c:forEach var="list" items="${librarybook_list}">
						<tr>
							<td>${list.book_name}</td>
							<td>${list.publisher}</td>
							<td>${list.author}</td>
							<td>${list.booktype_name}</td>
							<td>${list.library.name}</td>
							<td>${list.price}</td>
							
							
							
							<td><a
								href="LibraryBookController?command=libr_findLibraryBook&id=${list.id}"><button
										type="button" class="btn btn-primary" role="button">Edit</button></a></td>
							<td><a
								href="LibraryBookController?command=libr_deleteLibraryBook&id=${list.id}">
