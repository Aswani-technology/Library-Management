              ...
              <form id="form" action="${pageContext.servletContext.contextPath}/BookTypeController" method="post" class="form-horizontal">
                <section class="panel">
                  <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Edit Book Type</h2>
                  ...
                  <div class="panel-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="name" class="form-control" placeholder="Enter Book Type.." value="${book_type.name}"required="">
                      </div>
                    </div>
                  </div>
                   <input type="hidden" name="command" value="libr_update_book_type">
                   <input type="hidden" name="id" value="${book_type.id}">
