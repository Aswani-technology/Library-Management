...
<section role="main" class="content-body">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <form id="form" action="${pageContext.servletContext.contextPath}/LendingReqController" method="post" class="form-horizontal">
                <section class="panel">
                  ...
                  <option value="${user_det.id}">${user_det.first_name}</option> 
					</select>
                  ...
                  <select class="form-control" name="library_book">
                    <option value="${book_det.id}">${book_det.book_name}</option>
					</select>
					...
					<label class="col-md-3 control-label">Lending Date</label>
						<div class="col-sm-9">
							<div class="input-group">
								...
								<input type="text" id="LendingDate" data-plugin-datepicker class="form-control" name="lending_date">
							</div>
						</div>
				</div>
					...
					<label class="col-md-3 control-label">Return Date</label>
						<div class="col-sm-9">
							<div class="input-group">
								...
								<input type="text" data-plugin-datepicker class="form-control" name="return_date">
							</div>
						</div>
				</div>
                  ...
                  <option value="1">Available</option>
                   ...
                   <input type="hidden" name="command" value="add_lending_req">
